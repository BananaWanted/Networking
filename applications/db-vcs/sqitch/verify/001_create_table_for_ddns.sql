...
INSERT INTO ddns_record (user_id) SELECT id AS user_id FROM user_ident WHERE email = 'haha@a.com';

INSERT INTO ddns_remote_report (user_id, secret_id, ip)
    SELECT user_id, secret_id, '192.168.1.1'FROM ddns_record JOIN user_ident ON user_id = user_ident.id
